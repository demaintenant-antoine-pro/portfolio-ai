...
const T = {
  en: {
    ...
    heroSub1: "AI Expert. I help enterprises",
    heroSub1b: "deploy AI in their operations, train their C-levels to run it, and build the custom applications",
    heroSub2: " that automate the work their current stack can't.",
    heroSub3: "5+ yrs · CPG · SaaS · CSR · Python · Agentic AI · Power BI · LLMs.",
    xp: "yrs XP",
  ...
  fr: {
    ...
    heroSub1: "Expert IA. J'accompagne les entreprises pour",
    heroSub1b: "déployer l'IA dans leurs opérations, former leurs C-levels à la piloter, et construire les applications sur mesure",
    heroSub2: " qui automatisent ce que leur stack actuelle ne sait pas faire.",
    heroSub3: "5+ ans · CPG · SaaS · RSE · Python · IA agentique · Power BI · LLMs.",
    xp: "ans d'XP",
...
function PortfolioApp({
  ...
  return /*#__PURE__*/React.createElement(LangCtx.Provider, {
  ...
  }, t.recruiterBtn, " \u26A1"), /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      position: 'relative',
      zIndex: 5,
      background: 'rgba(191,58,255,.06)',
      borderTop: '1px solid rgba(191,58,255,.15)',
      borderBottom: '1px solid rgba(191,58,255,.15)',
      padding: '10px 0',
      overflow: 'hidden',
      marginTop: '60px',
      display: 'flex',
