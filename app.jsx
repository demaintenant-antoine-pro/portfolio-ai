...
const T={en:{
  ...
  heroSub1:"I implement AI transformation",heroSub1b:"and automate everything in your business",heroSub2:"— self-running pipelines, real-time decision dashboards, LLM-powered workflows. I don't just build reports: I eliminate the manual work and maximize ROI at scale.",heroSub3:"AI Architect · Automation · BI · 5+ yrs CPG, SaaS & CSR.",heroSub4:"",
  ...
  heroSub1:"Je mets en place la transformation IA",heroSub1b:"et j'automatise tout ce qui peut l'être",heroSub2:"— pipelines autonomes, dashboards décisionnels temps réel, workflows LLM. Je ne fais pas que des rapports : j'élimine le travail manuel et maximise le ROI à l'échelle.",heroSub3:"Architecte IA · Automatisation · BI · 5+ ans CPG, SaaS & RSE.",heroSub4:"",
